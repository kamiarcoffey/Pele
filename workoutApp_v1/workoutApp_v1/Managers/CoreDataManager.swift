...
//    }
//
//    func saveWorkout(workout: Workout) { // Workout is an NSManagedObject type. Exercise is local
//
//        // at this point the workout should be fully completed with associated sets etc
//
//
//    }
